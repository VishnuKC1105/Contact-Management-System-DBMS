...
Top.pack(side=TOP)
Mid = Frame(root, width=500,  bg="grey")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="grey")
...
#============================BUTTONS=====================================
btn_add = Button(MidLeft,font=('arial', 16), text="ADD NEW", bg="orange", command=AddNewWindow)
btn_add.pack()
btn_delete = Button(MidRight,font=('arial', 16), text="DELETE", bg="orange", command=DeleteData)
